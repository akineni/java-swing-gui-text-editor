...
public class JFontChooser extends JComponent
{
	...
	private static final Font DEFAULT_SELECTED_FONT = new Font("Lucida Console", Font.PLAIN, 14);
	...
	//private ResourceBundle messageCatalog = ResourceBundle.getBundle(JFontChooser.class.getName() 
        //+ "Messages", getLocale());
	...
	public JTextField getFontFamilyTextField()
	{
		if (fontFamilyTextField == null)
		{
			...
			fontFamilyTextField.getDocument().addDocumentListener(
				new ListSearchTextFieldDocumentHandler(getFontFamilyList(), getFontFamilies()));
	...
	public JTextField getFontStyleTextField()
	{
		if (fontStyleTextField == null)
		{
			...
			fontStyleTextField.getDocument().addDocumentListener(
				new ListSearchTextFieldDocumentHandler(getFontStyleList(), getFontStyleNames()));
	...
	public JTextField getFontSizeTextField()
	{
		if (fontSizeTextField == null)
		{
			...
			fontSizeTextField.getDocument().addDocumentListener(
				new ListSearchTextFieldDocumentHandler(getFontSizeList(), this.fontSizeStrings));
	...
	public JList getFontFamilyList()
	{
		...
		{
			fontNameList = new JList(getFontFamilies(true));
	...
	public JList getFontStyleList()
	{
		...
		{
			fontStyleList = new JList(getFontStyleNames(true));
		...
		public void valueChanged(ListSelectionEvent e)
		{
			if (e.getValueIsAdjusting() == false)
			{
				...
				String selectedValue = (String) list.getSelectedValue();
                                ...
                                doc = Jsoup.parse(selectedValue);
                                selectedValue = doc.text();
	...
	{
		JList targetList;
                JList dummyList = null;

		public ListSearchTextFieldDocumentHandler(JList targetList, String[] dummyListModel)
		{
			this.targetList = targetList;
                        dummyList = new JList(dummyListModel);
		}
		...
		private void update(DocumentEvent event)
		{
			...
			{
				int index = dummyList.getNextMatch(newValue, 0, Position.Bias.Forward); //dummyList
				if (index < 0)
				{
					index = 0;
				}
				...
				String matchedName = dummyList.getModel().getElementAt(index).toString(); //dummyList
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			fontNamePanel.setPreferredSize(new Dimension(250, 190));
			...
			JLabel label = new JLabel("Font family");
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			fontStylePanel.setPreferredSize(new Dimension(160, 190));
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			fontSizePanel.setPreferredSize(new Dimension(70, 190));
	...
	protected JLabel getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText.setPreferredSize(new Dimension(300, 110));
		}
		return sampleText;
	}
	...
	{
		return getFontFamilies(false);
	}
        
        
        protected String[] getFontFamilies(boolean html)
	{
		if (fontFamilyNames == null)
		{
			...
			fontFamilyNames = env.getAvailableFontFamilyNames();
                        ...
                        if(html){
                            int i = 0;
                            String[] htmlFontFamilyNames = new String[fontFamilyNames.length];
                            for(String s: fontFamilyNames){
                                htmlFontFamilyNames[i] = "<html><span style=\"font-family:'" + fontFamilyNames[i] +
                                        "'\">" + fontFamilyNames[i] + "</span></html>";
                                i++;
                            }
                            return htmlFontFamilyNames;
                        }
		}
	...
	{
		return getFontStyleNames(false);
	}
        
        protected String[] getFontStyleNames(boolean html)
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = "BoldItalic";
                        if(html) {
                            String[] htmlFontStyleNames = new String[4];
                            htmlFontStyleNames[0] = "<html>Plain</html>";
                            htmlFontStyleNames[1] = "<html><b>Bold</b></html>";
                            htmlFontStyleNames[2] = "<html><i>Italic</i></html>";
                            htmlFontStyleNames[3] = "<html><b><i>BoldItalic</i></b></html>";
                            return htmlFontStyleNames;
                        }
		}
        ...
        protected void updateFontStyleListTexts() {
            if(!"".equals(getSelectedFontFamily())){
                fontStyleList.setFont(new Font(getSelectedFontFamily(), Font.PLAIN, 13));
            }
        }
